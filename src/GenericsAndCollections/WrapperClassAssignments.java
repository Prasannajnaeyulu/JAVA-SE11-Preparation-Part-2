...
//    static Boolean myStaticBoolean;  // default is null
//    // Runtime error: NullPointerException. myStaticBoolean above has default value 'null'
//    // assigning null to primitive type throws nullpointer exception
//    boolean myInstanceboolean = myStaticBoolean;

    // It is valid now as we are assigning true by default
